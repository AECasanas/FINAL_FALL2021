...
(function ($, window, document, undefined) {
    ...
    $.fn.slidea.contentLayout = function () {
        ...
        layout.init = function () {
            ...
            // Add Classes
            // ---------------------
            layout.slider.element.addClass('slidea-content');

            $(window).resize(function(){
                var contentHeight = $('.slidea-content', layout.slider.active).height()

                layout.slider.element.css({
                    height: contentHeight
                });
                layout.slider.inner.css({
                    height: contentHeight
                });
            })
        };
        ...
        layout.slide = function (i, prev) {
            ...
            var contentHeight = $('.slidea-content', layout.slider.slides.eq(i)).height()

            layout.slider.element.velocity({
                height: contentHeight
            });
            layout.slider.inner.velocity({
                height: contentHeight
            });
     ...
     */
    $.slidea.addLayout("content", $.fn.slidea.contentLayout);
