...
(function ($, window, document, undefined) {
    ...
    $.fn.slidea.fluidLayout = function () {
        ...
        layout.init = function () {
            ...
            // Add Classes
            // ---------------------
            layout.slider.element.addClass('slidea-fluid');
        };
        ...
        layout.setup = function () {
            ...
            layout.slider.element.height(layout.slider.parentHeight);
            layout.slider.element.width(layout.slider.parentWidth);

            // Slider Size
            // ---------------------
            // @if parentHeight > sliderHeight
            //      Set 100% height to slides
            // @else
            //      Set 100% width to slides
            if (layout.slider.parentHeight > layout.slider.elementHeight) {

                layout.slider.elementHeight = layout.slider.parentHeight;
                layout.slider.elementWidth = layout.slider.elementHeight / layout.slider.settings.height * layout.slider.settings.width;

                layout.slider.inner.height(layout.slider.elementHeight);
                layout.slider.inner.width(layout.slider.elementWidth);
            } else {
                layout.slider.elementWidth = layout.slider.parentWidth;
                layout.slider.elementHeight = layout.slider.elementWidth / layout.slider.settings.width * layout.slider.settings.height;
            ...
            layout.slider.slides.each(function (i) {
                ...
                var marginLeft = -(layout.slider.visibleWidth - layout.slider.parentWidth) / 2;
                var marginTop = -(layout.slider.visibleHeight - layout.slider.parentHeight) / 2;
                ...
                $layers.each(function (layerIndex) {
                    ...
                    if ('top' in layout.slider.cache[i].layer[layerIndex].position)
                        layerCSS.top = heightRatio * layout.slider.cache[i].layer[layerIndex].position.top + marginTop;
                    else if ('bottom' in layout.slider.cache[i].layer[layerIndex].position)
                        layerCSS.bottom = heightRatio * layout.slider.cache[i].layer[layerIndex].position.bottom - marginTop;


                    if ('left' in layout.slider.cache[i].layer[layerIndex].position)
                        layerCSS.left = widthRatio * layout.slider.cache[i].layer[layerIndex].position.left + marginLeft;
                    else if ('right' in layout.slider.cache[i].layer[layerIndex].position)
                        layerCSS.right = widthRatio * layout.slider.cache[i].layer[layerIndex].position.right - marginLeft;
                ...
                if ($videobackground.length) {
                    ...
                    marginLeft = -(videoWidth - layout.slider.parentWidth) / 2;
                    marginTop = -(videoHeight - layout.slider.parentHeight) / 2;
     ...
     */
    $.slidea.addLayout("fluid", $.fn.slidea.fluidLayout);
